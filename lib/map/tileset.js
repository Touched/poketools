...
function loadTileset(buf, offset) {
    ...
    var tiles = pointerToOffset(buf, offset + 4),
        paletteData = pointerToOffset(buf, offset + 8),
        blockData = pointerToOffset(buf, offset + 0xC),
        funcPtr = pointerToOffset(buf, offset + 0x10),
        behaviours = pointerToOffset(buf, offset + 0x14);
